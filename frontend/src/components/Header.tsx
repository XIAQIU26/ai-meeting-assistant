...
export function Header({ projects, currentProject, onProjectChange, onProjectCreate, onProjectUpdate, onProjectDelete, isRemote, onLogout }: HeaderProps) {
  ...
  return (
    <header className="flex flex-col gap-3 border-b border-slate-200 bg-white px-5 py-4 lg:flex-row lg:items-center lg:justify-between">
      ...
      <div className="flex items-center gap-3">
        ...
        <UserMenu isRemote={isRemote} onLogout={onLogout} />
      </div>
    </header>
  );
}
